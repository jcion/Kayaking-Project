...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">CanoeKids/CanoeKids+ Summer Camps
            </h1>
            <ol class="breadcrumb">
                <li><a href="index.html">Home</a>
                </li>
                <li class="active">CanoeKids/CanoeKids+ Summer Camps</li>
            </ol>
        </div>
    </div>
    <!-- /.row -->
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <!-- Preview Image -->
            <img class="img-responsive" src="resources/images/kidprogrampicture.jpg" alt="">
